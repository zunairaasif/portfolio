    ...
    >
      <div className="flex flex-col justify-center gap-10 w-full">
        ...
        <span className="xl:text-sm text-xs text-gray-300 tracking-wide leading-5">
          ...
          the heart of my work. <br /> <br /> I believe the best results come
          from close collaboration, clear communication, and a shared commitment
          to excellence. Whether you need a dynamic web app or a sleek
          interactive interface, I'll be with you at every step—from concept to
