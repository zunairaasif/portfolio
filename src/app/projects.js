...
const projectDetails = [
  {
    ...
    tools: ["Shopify"],
    desc: "I customized a Shopify theme to align precisely with the client’s vision, refining both design and functionality. Beyond selling clothing, the site also offers tailored services. Several code-level adjustments were made to ensure an optimal user experience and meet specific client requirements.",
    img: [
